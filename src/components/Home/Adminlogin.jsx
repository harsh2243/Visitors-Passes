    ...
    <div>
      <header className="sticky inset-0 z-50 border-b border-slate-100 bg-white/80 backdrop-blur-lg">
            ...
            <div className='w-1/2 p-5 mt-5'>
                <img src="https://img.freepik.com/free-vector/developers-testing-software_74855-4782.jpg" alt="Image" style={{ maxWidth: '100%', height: 'auto' }} />
            </div>
    <div class="bg-grey-lighter min-h-screen flex flex-col w-1/2 p-2">
      <div class="container max-w-sm mx-auto flex-1 flex flex-col items-center justify-center px-2">
      <div class="text-center font-bold text-3xl ">Admin Login</div><br></br>
