...
const Student = () => {
  ...
  return (
    <div className="relative bg-orange-100 overflow-hidden max-h-screen">
    ...
    <div className="flex flex-col justify-between h-full">
      <div className="flex-grow">
        <div className="px-4 py-6 text-center border-b">
          <h1 className="text-xl font-bold leading-none"><span className="text-orange-500">Visitor</span> Panel</h1>
        </div>
        <div className="p-4">
          <ul className="space-y-1">
            <li>
                <NavLink to="/student/" className={({isActive})=>`${isActive? 'bg-orange-100' : 'hover:bg-orange-50'} flex items-center rounded-xl font-bold text-sm text-orange-500 py-3 px-4`}>
            ...
            <li>
              <NavLink to="/student/history" className={({isActive})=> `${isActive? 'bg-orange-100' : 'hover:bg-orange-50'} flex bg-white  rounded-xl font-bold text-sm text-orange-500 py-3 px-4`}>
                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" className="text-lg mr-4" viewBox="0 0 16 16">
            ...
            <li>
              <NavLink to="/student/request" className={({isActive}) => `${isActive? 'bg-orange-100' : ''} flex bg-white hover:bg-orange-50 rounded-xl font-bold text-sm text-orange-500 py-3 px-4`}>
                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" className="text-lg mr-4" viewBox="0 0 16 16">
